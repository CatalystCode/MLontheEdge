...
def main():
    ...
    camera_device.capture('testimge.jpg')
    block_blob_service.create_blob_from_path('images/testdir','testImage','testimge.jpg',content_settings=ContentSettings(content_type='image/jpeg'))
